...
import { OurMission } from "@/components/stallio/sections/about/OurMission";
...
const description =
  "Stallio gives Instagram and WhatsApp sellers a real storefront — no domain, no payment gateway, no code. Learn why we built it and who it's for.";
